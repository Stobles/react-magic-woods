      ...
      <div className='container'>
        <div className={styles.Inner}>
          <div className={styles.Content}>
            ...
            <Description
              text={
                `Деревянная карта мира может гармонично вписаться в дизайн вашей
                комнаты и стать недостающим элементом в создании
                уникального стиля. Оставьте свой номер телефона и мы перезвоним
